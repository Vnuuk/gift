...
(function($) {
    ...
    $.magnificPopup.registerModule('gallery', {options: {enabled: false,arrowMarkup: '<button title="%title%" type="button" class="mfp-arrow mfp-arrow-%dir%"></button>',preload: [0, 2],navigateByImgClick: true,arrows: true,tPrev: 'Previous (Left arrow key)',tNext: 'Next (Right arrow key)',tCounter: '%curr% / %total%'},proto: {initGallery: function() {
...
function adjustIframes() 
{
    jQuery('iframe').each(function() {
        var 
        $this = jQuery(this), proportion = $this.data('proportion'), w = $this.attr('width'), actual_w = $this.width();
        if (!proportion) 
        {
...
jQuery(document).ready(function() {
    ...
    jQuery('.lightbox_youtube, .lightbox_vimeo').magnificPopup({src: jQuery(this).attr('href'),type: 'inline',removalDelay: 300,mainClass: 'mfp-fade'});
    jQuery('a.fancy-gallery, .flickr li a, .pp_gallery a').magnificPopup({type: 'image',removalDelay: 300,mainClass: 'mfp-fade',gallery: {enabled: true}});
    ...
    function reLayout() {
        ...
        var masonryOpts = {columnWidth: $container.width() / columnCount};
        $container.addClass('visible');
        $container.isotope({resizable: false,itemSelector: '.wall_entry',masonry: masonryOpts}).isotope('reLayout');
    }
    jQuery(window).resize(function() {
    ...
    function rePortfolioLayout() {
        ...
        var masonryOpts = {columnWidth: parseInt(columnValue)};
    ...
    function reBlogLayout() {
        ...
        var masonryOpts = {columnWidth: columnValue};
    ...
    jQuerygalleriescontainer.imagesLoaded(function() {
        var columnCount = 3;
        var masonryOpts = {columnWidth: jQuerygalleriescontainer.width() / columnCount};
        jQuerygalleriescontainer.isotope({resizable: false,itemSelector: '.galleries.type-galleries',masonry: masonryOpts}).isotope();
    });
